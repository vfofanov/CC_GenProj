...
{
    internal abstract class CodeBehindProductWizardPresenter : BaseWizardPresenter<Products, int, ProductWizard>
    {
        ...
        protected virtual IQueryable<Categories> GetCategoryIDDataSourceOnPage1()
        {
            return SessionGlobalServices.GetManager<Categories,int>().GetAllObjects();
        }
        ...
        protected virtual IQueryable<Suppliers> GetSupplierIDDataSourceOnPage1()
        {
            return SessionGlobalServices.GetManager<Suppliers,int>().GetAllObjects();
        }
