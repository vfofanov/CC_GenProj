...
{
    [Serializable]
	[DebuggerDisplay("OrdersQuery" + " {"+ nameof(Id) +"}")]
	[TypeDisplay(typeof(QueryResources))]
	[Microsoft.OData.Client.Key(nameof(Id))]
    public abstract class CodeBehindOrdersQuery : ClassicDataObject<int, OrdersQuery>
    {
	    /// <summary>
        ///     Object's creation method for OData
        /// </summary>
	    public static OrdersQuery CreateOrdersQuery(int id)
        {
            return new OrdersQuery {Id = id};
        }
        ...
        protected CodeBehindOrdersQuery()
		{
		}

		protected CodeBehindOrdersQuery(OrdersQuery origin)
		    :base(origin)
	    {
		...
		[Display(ResourceType = typeof(QueryResources), Name = "OrdersQuery_CustomerID")]
		...
		[Display(ResourceType = typeof(QueryResources), Name = "OrdersQuery_Customers_Address")]
		...
		[Display(ResourceType = typeof(QueryResources), Name = "OrdersQuery_Customers_City")]
		...
		[Display(ResourceType = typeof(QueryResources), Name = "OrdersQuery_Customers_CompanyName")]
		...
		[Display(ResourceType = typeof(QueryResources), Name = "OrdersQuery_Customers_ContactName")]
		...
		[Display(ResourceType = typeof(QueryResources), Name = "OrdersQuery_Customers_ContactTitle")]
		...
		[Display(ResourceType = typeof(QueryResources), Name = "OrdersQuery_Customers_Country")]
		...
		[Display(ResourceType = typeof(QueryResources), Name = "OrdersQuery_Customers_Fax")]
		...
		[Display(ResourceType = typeof(QueryResources), Name = "OrdersQuery_Customers_Id")]
		...
		[Display(ResourceType = typeof(QueryResources), Name = "OrdersQuery_Customers_Phone")]
		...
		[Display(ResourceType = typeof(QueryResources), Name = "OrdersQuery_Customers_PostalCode")]
		...
		[Display(ResourceType = typeof(QueryResources), Name = "OrdersQuery_Customers_Region")]
		...
		[Display(ResourceType = typeof(QueryResources), Name = "OrdersQuery_EmployeeFullName")]
		...
		[Display(ResourceType = typeof(QueryResources), Name = "OrdersQuery_EmployeeID")]
		...
		[Display(ResourceType = typeof(QueryResources), Name = "OrdersQuery_Employees_Address")]
		...
		[Display(ResourceType = typeof(QueryResources), Name = "OrdersQuery_Employees_BirthDate")]
		...
		[Display(ResourceType = typeof(QueryResources), Name = "OrdersQuery_Employees_City")]
		...
		[Display(ResourceType = typeof(QueryResources), Name = "OrdersQuery_Employees_Country")]
		...
		[Display(ResourceType = typeof(QueryResources), Name = "OrdersQuery_Employees_Extension")]
		...
		[Display(ResourceType = typeof(QueryResources), Name = "OrdersQuery_Employees_FirstName")]
		...
		[Display(ResourceType = typeof(QueryResources), Name = "OrdersQuery_Employees_HireDate")]
		...
		[Display(ResourceType = typeof(QueryResources), Name = "OrdersQuery_Employees_HomePhone")]
		...
		[Display(ResourceType = typeof(QueryResources), Name = "OrdersQuery_Employees_Id")]
		...
		[Display(ResourceType = typeof(QueryResources), Name = "OrdersQuery_Employees_LastName")]
		...
		[Display(ResourceType = typeof(QueryResources), Name = "OrdersQuery_Employees_Notes")]
		...
		[Display(ResourceType = typeof(QueryResources), Name = "OrdersQuery_Employees_PhotoPath")]
		...
		[Display(ResourceType = typeof(QueryResources), Name = "OrdersQuery_Employees_PostalCode")]
		...
		[Display(ResourceType = typeof(QueryResources), Name = "OrdersQuery_Employees_Region")]
		...
		[Display(ResourceType = typeof(QueryResources), Name = "OrdersQuery_Employees_ReportsTo")]
		...
		[Display(ResourceType = typeof(QueryResources), Name = "OrdersQuery_Employees_Title")]
		...
		[Display(ResourceType = typeof(QueryResources), Name = "OrdersQuery_Employees_TitleOfCourtesy")]
		...
		[Display(ResourceType = typeof(QueryResources), Name = "OrdersQuery_Freight")]
		...
		[Display(ResourceType = typeof(QueryResources), Name = "OrdersQuery_OrderDate")]
		...
		[Display(ResourceType = typeof(QueryResources), Name = "OrdersQuery_RequiredDate")]
		...
		[Display(ResourceType = typeof(QueryResources), Name = "OrdersQuery_ShipAddress")]
		...
		[Display(ResourceType = typeof(QueryResources), Name = "OrdersQuery_ShipCity")]
		...
		[Display(ResourceType = typeof(QueryResources), Name = "OrdersQuery_ShipCountry")]
		...
		[Display(ResourceType = typeof(QueryResources), Name = "OrdersQuery_ShipName")]
		...
		[Display(ResourceType = typeof(QueryResources), Name = "OrdersQuery_ShippedDate")]
		...
		[Display(ResourceType = typeof(QueryResources), Name = "OrdersQuery_Shippers_CompanyName")]
		...
		[Display(ResourceType = typeof(QueryResources), Name = "OrdersQuery_Shippers_Id")]
		...
		[Display(ResourceType = typeof(QueryResources), Name = "OrdersQuery_Shippers_Phone")]
		...
		[Display(ResourceType = typeof(QueryResources), Name = "OrdersQuery_ShipPostalCode")]
		...
		[Display(ResourceType = typeof(QueryResources), Name = "OrdersQuery_ShipRegion")]
		...
		[Display(ResourceType = typeof(QueryResources), Name = "OrdersQuery_ShipVia")]
