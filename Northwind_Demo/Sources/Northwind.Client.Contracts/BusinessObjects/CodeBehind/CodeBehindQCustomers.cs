...
{
    [Serializable]
	[DebuggerDisplay("QCustomers" + " {"+ nameof(Id) +"}")]
	[TypeDisplay(typeof(QueryResources))]
	[Microsoft.OData.Client.Key(nameof(Id))]
    public abstract class CodeBehindQCustomers : ClassicDataObject<int, QCustomers>
    {
	    /// <summary>
        ///     Object's creation method for OData
        /// </summary>
	    public static QCustomers CreateQCustomers(int id)
        {
            return new QCustomers {Id = id};
        }
        ...
        protected CodeBehindQCustomers()
		{
		}

		protected CodeBehindQCustomers(QCustomers origin)
		    :base(origin)
	    {
		...
		[Display(ResourceType = typeof(QueryResources), Name = "qCustomers_Address")]
		...
		[Display(ResourceType = typeof(QueryResources), Name = "qCustomers_City")]
		...
		[Display(ResourceType = typeof(QueryResources), Name = "qCustomers_CompanyName")]
		...
		[Display(ResourceType = typeof(QueryResources), Name = "qCustomers_ContactName")]
		...
		[Display(ResourceType = typeof(QueryResources), Name = "qCustomers_ContactTitle")]
		...
		[Display(ResourceType = typeof(QueryResources), Name = "qCustomers_Country")]
		...
		[Display(ResourceType = typeof(QueryResources), Name = "qCustomers_Fax")]
		...
		[Display(ResourceType = typeof(QueryResources), Name = "qCustomers_Phone")]
		...
		[Display(ResourceType = typeof(QueryResources), Name = "qCustomers_PostalCode")]
		...
		[Display(ResourceType = typeof(QueryResources), Name = "qCustomers_Region")]
