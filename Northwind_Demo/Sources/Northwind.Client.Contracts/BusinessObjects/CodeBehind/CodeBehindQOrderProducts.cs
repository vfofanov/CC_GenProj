...
{
    [Serializable]
	[DebuggerDisplay("QOrderProducts" + " {"+ nameof(Id) +"}")]
	[TypeDisplay(typeof(QueryResources))]
	[Microsoft.OData.Client.Key(nameof(Id))]
    public abstract class CodeBehindQOrderProducts : ClassicDataObject<int, QOrderProducts>
    {
	    /// <summary>
        ///     Object's creation method for OData
        /// </summary>
	    public static QOrderProducts CreateQOrderProducts(int id)
        {
            return new QOrderProducts {Id = id};
        }
        ...
        protected CodeBehindQOrderProducts()
		{
		}

		protected CodeBehindQOrderProducts(QOrderProducts origin)
		    :base(origin)
	    {
		...
		[Display(ResourceType = typeof(QueryResources), Name = "qOrderProducts_Discount")]
		...
		[Display(ResourceType = typeof(QueryResources), Name = "qOrderProducts_OrderID")]
		...
		[Display(ResourceType = typeof(QueryResources), Name = "qOrderProducts_Orders_CustomerID")]
		...
		[Display(ResourceType = typeof(QueryResources), Name = "qOrderProducts_Orders_EmployeeID")]
		...
		[Display(ResourceType = typeof(QueryResources), Name = "qOrderProducts_Orders_Freight")]
		...
		[Display(ResourceType = typeof(QueryResources), Name = "qOrderProducts_Orders_Id")]
		...
		[Display(ResourceType = typeof(QueryResources), Name = "qOrderProducts_Orders_OrderDate")]
		...
		[Display(ResourceType = typeof(QueryResources), Name = "qOrderProducts_Orders_RequiredDate")]
		...
		[Display(ResourceType = typeof(QueryResources), Name = "qOrderProducts_Orders_ShipAddress")]
		...
		[Display(ResourceType = typeof(QueryResources), Name = "qOrderProducts_Orders_ShipCity")]
		...
		[Display(ResourceType = typeof(QueryResources), Name = "qOrderProducts_Orders_ShipCountry")]
		...
		[Display(ResourceType = typeof(QueryResources), Name = "qOrderProducts_Orders_ShipName")]
		...
		[Display(ResourceType = typeof(QueryResources), Name = "qOrderProducts_Orders_ShippedDate")]
		...
		[Display(ResourceType = typeof(QueryResources), Name = "qOrderProducts_Orders_ShipPostalCode")]
		...
		[Display(ResourceType = typeof(QueryResources), Name = "qOrderProducts_Orders_ShipRegion")]
		...
		[Display(ResourceType = typeof(QueryResources), Name = "qOrderProducts_Orders_ShipVia")]
		...
		[Display(ResourceType = typeof(QueryResources), Name = "qOrderProducts_ProductID")]
		...
		[Display(ResourceType = typeof(QueryResources), Name = "qOrderProducts_Products_CategoryID")]
		...
		[Display(ResourceType = typeof(QueryResources), Name = "qOrderProducts_Products_Discontinued")]
		...
		[Display(ResourceType = typeof(QueryResources), Name = "qOrderProducts_Products_Id")]
		...
		[Display(ResourceType = typeof(QueryResources), Name = "qOrderProducts_Products_ProductName")]
		...
		[Display(ResourceType = typeof(QueryResources), Name = "qOrderProducts_Products_QuantityPerUnit")]
		...
		[Display(ResourceType = typeof(QueryResources), Name = "qOrderProducts_Products_ReorderLevel")]
		...
		[Display(ResourceType = typeof(QueryResources), Name = "qOrderProducts_Products_SupplierID")]
		...
		[Display(ResourceType = typeof(QueryResources), Name = "qOrderProducts_Products_UnitPrice")]
		...
		[Display(ResourceType = typeof(QueryResources), Name = "qOrderProducts_Products_UnitsInStock")]
		...
		[Display(ResourceType = typeof(QueryResources), Name = "qOrderProducts_Products_UnitsOnOrder")]
		...
		[Display(ResourceType = typeof(QueryResources), Name = "qOrderProducts_Quantity")]
		...
		[Display(ResourceType = typeof(QueryResources), Name = "qOrderProducts_UnitPrice")]
