...
{
    [Serializable]
	[DebuggerDisplay("QProducts" + " {"+ nameof(Id) +"}")]
	[TypeDisplay(typeof(QueryResources))]
	[Microsoft.OData.Client.Key(nameof(Id))]
    public abstract class CodeBehindQProducts : ClassicDataObject<int, QProducts>
    {
	    /// <summary>
        ///     Object's creation method for OData
        /// </summary>
	    public static QProducts CreateQProducts(int id)
        {
            return new QProducts {Id = id};
        }
        ...
        protected CodeBehindQProducts()
		{
		}

		protected CodeBehindQProducts(QProducts origin)
		    :base(origin)
	    {
		...
		[Display(ResourceType = typeof(QueryResources), Name = "qProducts_Categories_CategoryName")]
		...
		[Display(ResourceType = typeof(QueryResources), Name = "qProducts_Categories_Description")]
		...
		[Display(ResourceType = typeof(QueryResources), Name = "qProducts_Categories_Id")]
		...
		[Display(ResourceType = typeof(QueryResources), Name = "qProducts_CategoryID")]
		...
		[Display(ResourceType = typeof(QueryResources), Name = "qProducts_Discontinued")]
		...
		[Display(ResourceType = typeof(QueryResources), Name = "qProducts_ProductName")]
		...
		[Display(ResourceType = typeof(QueryResources), Name = "qProducts_QuantityPerUnit")]
		...
		[Display(ResourceType = typeof(QueryResources), Name = "qProducts_ReorderLevel")]
		...
		[Display(ResourceType = typeof(QueryResources), Name = "qProducts_SupplierID")]
		...
		[Display(ResourceType = typeof(QueryResources), Name = "qProducts_Suppliers_Address")]
		...
		[Display(ResourceType = typeof(QueryResources), Name = "qProducts_Suppliers_City")]
		...
		[Display(ResourceType = typeof(QueryResources), Name = "qProducts_Suppliers_CompanyName")]
		...
		[Display(ResourceType = typeof(QueryResources), Name = "qProducts_Suppliers_ContactName")]
		...
		[Display(ResourceType = typeof(QueryResources), Name = "qProducts_Suppliers_ContactTitle")]
		...
		[Display(ResourceType = typeof(QueryResources), Name = "qProducts_Suppliers_Country")]
		...
		[Display(ResourceType = typeof(QueryResources), Name = "qProducts_Suppliers_Fax")]
		...
		[Display(ResourceType = typeof(QueryResources), Name = "qProducts_Suppliers_HomePage")]
		...
		[Display(ResourceType = typeof(QueryResources), Name = "qProducts_Suppliers_Id")]
		...
		[Display(ResourceType = typeof(QueryResources), Name = "qProducts_Suppliers_Phone")]
		...
		[Display(ResourceType = typeof(QueryResources), Name = "qProducts_Suppliers_PostalCode")]
		...
		[Display(ResourceType = typeof(QueryResources), Name = "qProducts_Suppliers_Region")]
		...
		[Display(ResourceType = typeof(QueryResources), Name = "qProducts_UnitPrice")]
		...
		[Display(ResourceType = typeof(QueryResources), Name = "qProducts_UnitsInStock")]
		...
		[Display(ResourceType = typeof(QueryResources), Name = "qProducts_UnitsOnOrder")]
