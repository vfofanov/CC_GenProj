...
{
    internal abstract class CodeBehindEmployeeWizardPresenter : BaseWizardPresenter<Employees, int, EmployeeWizard>
    {
        ...
        protected override void OnObjectPropertyChanged(PropertyChangedEventArgs e)
        {
            ...
            case "Notes":
                ...
                Wizard.RefreshStepValidationStyle(Wizard.Page1);
                break;
            case "DocumentScanFileId":
                Wizard.Page1.DocumentScanFileIdHolder.Error = GetPage1_DocumentScanFileIdValidate();
                Wizard.RefreshStepValidationStyle(Wizard.Page1);
                break;
            }
        ...
        protected sealed override void RefreshVisibility()
        {
            ...
            Wizard.Page1.DocumentScanFileIdHolder.Visible = GetPage1_DocumentScanFileIdVisibility();
            Wizard.Page1.ResumeLayout(true);
        ...
        protected sealed override void RefreshAccessibility()
        {
            ...
            Wizard.Page1.DocumentScanFileIdHolder.ReadOnly = !GetPage1_DocumentScanFileIdAcessibility();
            Wizard.Page1.ResumeLayout(true);
        ...
        protected sealed override void RefreshRequiredStyles()
        {
            ...
            Wizard.Page1.DocumentScanFileIdHolder.RequiredStyle = GetPage1_DocumentScanFileIdRequiredStyle();
            Wizard.Page1.ResumeLayout(true);
        ...
        protected virtual bool GetPage1_DocumentScanFileIdVisibility()
        {
            return CurrentObject.IsPropertyVisible("DocumentScanFileId");
        }

        protected virtual bool GetPage1_DocumentScanFileIdAcessibility()
        {
            return true;
        }

        protected virtual bool GetPage1_DocumentScanFileIdRequiredStyle()
        {
            return CurrentObject.IsPropertyRequired("DocumentScanFileId");
        }

        protected virtual string GetPage1_DocumentScanFileIdValidate()
        {
            return CurrentObject.GetPropertyValidation("DocumentScanFileId");
        }
