...
{
    [Serializable]
	[DebuggerDisplay("Customers" + " {"+ nameof(Id) +"}")]
	[TypeDisplay(typeof(ObjectResources))]
	[Microsoft.OData.Client.Key(nameof(Id))]
    public abstract class CodeBehindCustomers : ClassicDataObject<int, Customers>
    {
	    /// <summary>
        ///     Object's creation method for OData
        /// </summary>
	    public static Customers CreateCustomers(int id)
        {
            return new Customers {Id = id};
        }
        ...
        protected CodeBehindCustomers()
		{
		}

		protected CodeBehindCustomers(Customers origin)
		    :base(origin)
	    {
		...
		[Display(ResourceType = typeof(ObjectResources), Name = "Customers_Address")]
		...
		[Display(ResourceType = typeof(ObjectResources), Name = "Customers_City")]
        ...
        [RequiredValidator( MessageTemplateResourceType = typeof(ObjectResources), MessageTemplateResourceName = "Customers_CompanyName_RequiredMsg")]
		[Display(ResourceType = typeof(ObjectResources), Name = "Customers_CompanyName")]
		...
		[Display(ResourceType = typeof(ObjectResources), Name = "Customers_ContactName")]
		...
		[Display(ResourceType = typeof(ObjectResources), Name = "Customers_ContactTitle")]
		...
		[Display(ResourceType = typeof(ObjectResources), Name = "Customers_Country")]
		...
		[Display(ResourceType = typeof(ObjectResources), Name = "Customers_Fax")]
		...
		[Display(ResourceType = typeof(ObjectResources), Name = "Customers_Phone")]
		...
		[Display(ResourceType = typeof(ObjectResources), Name = "Customers_PostalCode")]
		...
		[Display(ResourceType = typeof(ObjectResources), Name = "Customers_Region")]
