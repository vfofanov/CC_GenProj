...
{
    [Serializable]
	[DebuggerDisplay("Suppliers" + " {"+ nameof(Id) +"}")]
	[TypeDisplay(typeof(ObjectResources))]
	[Microsoft.OData.Client.Key(nameof(Id))]
    public abstract class CodeBehindSuppliers : ClassicDataObject<int, Suppliers>
    {
	    /// <summary>
        ///     Object's creation method for OData
        /// </summary>
	    public static Suppliers CreateSuppliers(int id)
        {
            return new Suppliers {Id = id};
        }
        ...
        protected CodeBehindSuppliers()
		{
		}

		protected CodeBehindSuppliers(Suppliers origin)
		    :base(origin)
	    {
		...
		[Display(ResourceType = typeof(ObjectResources), Name = "Suppliers_Address")]
		...
		[Display(ResourceType = typeof(ObjectResources), Name = "Suppliers_City")]
        ...
        [RequiredValidator( MessageTemplateResourceType = typeof(ObjectResources), MessageTemplateResourceName = "Suppliers_CompanyName_RequiredMsg")]
		[Display(ResourceType = typeof(ObjectResources), Name = "Suppliers_CompanyName")]
		...
		[Display(ResourceType = typeof(ObjectResources), Name = "Suppliers_ContactName")]
		...
		[Display(ResourceType = typeof(ObjectResources), Name = "Suppliers_ContactTitle")]
		...
		[Display(ResourceType = typeof(ObjectResources), Name = "Suppliers_Country")]
		...
		[Display(ResourceType = typeof(ObjectResources), Name = "Suppliers_Fax")]
		...
		[Display(ResourceType = typeof(ObjectResources), Name = "Suppliers_HomePage")]
		...
		[Display(ResourceType = typeof(ObjectResources), Name = "Suppliers_Phone")]
		...
		[Display(ResourceType = typeof(ObjectResources), Name = "Suppliers_PostalCode")]
		...
		[Display(ResourceType = typeof(ObjectResources), Name = "Suppliers_Region")]
