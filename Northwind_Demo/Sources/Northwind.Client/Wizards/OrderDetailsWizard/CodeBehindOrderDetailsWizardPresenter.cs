...
{
    internal abstract class CodeBehindOrderDetailsWizardPresenter : BaseWizardPresenter<OrderDetail, int, OrderDetailsWizard>
    {
        ...
        protected virtual IQueryable<QProducts> GetProductIDDataSourceOnPage1()
        {
            return SessionGlobalServices.GetManager<QProducts,int>().GetAllObjects();
        }
