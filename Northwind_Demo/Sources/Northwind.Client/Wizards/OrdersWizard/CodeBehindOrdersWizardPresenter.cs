...
{
    internal abstract class CodeBehindOrdersWizardPresenter : BaseWizardPresenter<Order, int, OrdersWizard>
    {
        ...
        protected virtual IQueryable<QCustomers> GetCustomerIDDataSourceOnPage1()
        {
            return SessionGlobalServices.GetManager<QCustomers,int>().GetAllObjects();
        }
        ...
        protected virtual IQueryable<QEmployees> GetEmployeeIDDataSourceOnPage1()
        {
            return SessionGlobalServices.GetManager<QEmployees,int>().GetAllObjects();
        }
        ...
        protected virtual IQueryable<Shipper> GetShipViaDataSourceOnPage2()
        {
            return SessionGlobalServices.GetManager<Shipper,int>().GetAllObjects().OrderBy(o => o.CompanyName);
        }
